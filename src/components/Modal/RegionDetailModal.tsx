...
import { MortalityMultiplierTab } from './MortalityMultiplierTab';
    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4">
          {!isMortalityMetric && isLoading && (
            <div className="flex items-center justify-center h-64">
              <p className="text-gray-500">Loading data...</p>
            </div>
          )}

          {!isMortalityMetric && error && (
            <div className="flex items-center justify-center h-64">
          ...
          {!isMortalityMetric && !isLoading && !error && data && data.data.length === 0 && (
            <div className="flex items-center justify-center h-64">
              <div className="text-center">
                <p className="text-gray-600 font-medium">No data available</p>
                <p className="text-sm text-gray-500 mt-2">
          ...
          {(isMortalityMetric || (!isLoading && !error && data && data.data.length > 0)) && (
            <Tabs defaultValue={isMortalityMetric ? 'mortality' : 'timeseries'} className="w-full">
              ...
              <TabsContent value="timeseries" className="space-y-4">
                {isMortalityMetric ? (
                  <div className="flex items-center justify-center h-64 bg-gray-50 rounded-lg">
                    <p className="text-gray-500">Time series not available for Mortality Multiplier</p>
                  </div>
                ) : (
                  <>
                    <div>
              ...
              <TabsContent value="correlation" className="space-y-4">
                {isMortalityMetric ? (
                  <div className="flex items-center justify-center h-64 bg-gray-50 rounded-lg">
                    <p className="text-gray-500">Correlation not available for Mortality Multiplier</p>
                  </div>
                ) : !secondMetric ? (
                  <div className="flex items-center justify-center h-64 bg-gray-50 rounded-lg">
              ...
              {/* Mortality Multiplier Tab */}
              <TabsContent value="mortality" className="space-y-4">
                <MortalityMultiplierTab nutsId={selectedRegion} />
              </TabsContent>
